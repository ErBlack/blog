...
module.exports = async function cover(src, className) {
    ...
    return `<img alt="" class=${className} loading="lazy" decoding="async" src="${cover.jpeg[0].url}" width="${resultWidth}" height="${resultHeight}">`;
};
